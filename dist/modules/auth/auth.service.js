...
const bcrypt_constants_1 = require("./constants/bcrypt.constants");
let AuthService = class AuthService {
    ...
    async register(registerDto) {
        ...
        const passwordHash = await bcrypt.hash(registerDto.password, bcrypt_constants_1.BCRYPT_CONSTANTS.SALT_ROUNDS);
